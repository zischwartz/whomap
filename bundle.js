...
},{"./textures.js":13}],13:[function(require,module,exports){
...
d3.json('world-110m.json', function(error, world) {
  ...
  return d3.csv("population.csv", function(d) {
    ...
    for (l = 0, len1 = countries.length; l < len1; l++) {
      c = countries[l];
      name = convert_countries.getName(c.id, "EN");
      c["name"] = name;
      pop_data = pop_by_name[name];
      c["pop_in_k"] = pop_data != null ? pop_data["pop_in_k"] : void 0;
      c["urban"] = pop_data != null ? pop_data["urban"] : void 0;
      ref = path.bounds(c), b1 = ref[0], b2 = ref[1];
      w = b2[0] - b1[0];
      h = b2[1] - b1[1];
      max = c["urban"] / 10;
      padding = 5;
    ...
    samples = [];
    for (m = 0, len2 = ticks.length; m < len2; m++) {
      t = ticks[m];
      x = {
...
Quad = (function() {
  function Quad(maxRadius, padding1, width1, height1, autoadd) {
  ...
  Quad.prototype.add = function(b) {
    return this.quadtree.add(b);
  };

  Quad.prototype.make = function(k) {
...
},{"./brewer.js":1,"d3":2,"i18n-iso-countries":7,"jquery":10,"point-in-polygon":11,"textures":12,"topojson":14}]},{},[15]);
